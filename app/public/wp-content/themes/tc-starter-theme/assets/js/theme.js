...
window.addEventListener('load', function () {
  ...
  var sections = document.querySelectorAll('.tcMainSection');

  // Funzione che aggiorna il link attivo in base allo scroll
  function aggiornaLinkAttivo() {
    var posizioneScroll = window.scrollY;
    sections.forEach(function (sezione, index) {
      var offsetSuperiore = sezione.offsetTop - 70; // 70px per tenere conto dell'altezza del menu
      var altezzaSezione = sezione.offsetHeight;
      var offsetInferiore = offsetSuperiore + altezzaSezione;
...
function tcInitMenuAnimations() {
  ...
  var myOffcanvas = document.getElementById('tc-main-menu-offcanvas');
  var bsOffcanvas = bootstrap.Offcanvas.getOrCreateInstance(myOffcanvas);
  mediaQuery.addEventListener('change', function (event) {
    console.log(event);
    bsOffcanvas.hide();
  });
  var menuLinks = document.querySelectorAll('#tc-main-menu .nav-link');
  menuLinks.forEach(function (link) {
  ...
  function tcHandleOffcanvasShow() {
    document.querySelector('#tc-main-menu-offcanvas').addEventListener('show.bs.offcanvas', function () {
  ...
  function tcHandleOffcanvasHide() {
    document.querySelector('#tc-main-menu-offcanvas').addEventListener('hide.bs.offcanvas', function () {
...
imgCpt.forEach(function (imgCpt) {
  imgCpt.addEventListener('click', function () {
    var newTitle = this.getAttribute('data-title');
    var newExcerpt = this.getAttribute('data-excerpt');
